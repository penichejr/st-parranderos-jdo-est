...
public class Parranderos 
{
	...
	public Oficina adicionarOficina (String nombre, String direccion, String loginGerenteOficina)
	{
        ...
        Oficina oficina = pp.adicionarOficina(nombre, direccion, loginGerenteOficina);	
	...
	{
		log.info ("Consultando los Puntos de Atencion");
        List<PuntoDeAtencion> puntosDeAtencion = pp.darPuntosDeAtencion();	
	...
	public List<VOPuntoDeAtencion> darVOPuntosDeAtencion ()
	{
        ...
        List<VOPuntoDeAtencion> voPuntos = new LinkedList<VOPuntoDeAtencion> ();
        for (PuntoDeAtencion tb : pp.darPuntosDeAtencion())
        {
        	voPuntos.add (tb);
        }
	...
	public List<VOConsignarCuenta> consultarConsignacionesEntreFechas(String login, Timestamp fechaMin2, Timestamp fechaMax2, int montoSi) {
		// TODO Auto-generated method stub
		log.info ("Generando los VO de las consignaciones");        
        List<VOConsignarCuenta> voConsignar = new LinkedList<VOConsignarCuenta> ();
        for (ConsignarCuenta tb : pp.darConsignacionesEntreFechas(login, fechaMin2, fechaMax2, montoSi))
        {
        	voConsignar.add (tb);
        }
        log.info ("Generando los VO de la consignaciones: " + voConsignar.size() + " existentes");
	...
	{
        log.info ("Adicionando punto de atencion: " + tipo);
        PuntoDeAtencion puntoDeAtencion = pp.adicionarPuntoDeAtencion(tipo, localizacion, idOficina);		
        log.info ("Adicionando punto de atencion: " + puntoDeAtencion);
			...
			int valorCuotaMinima, String loginCliente)
	{
        ...
        Prestamo prestamo = pp.adicionarPrestamo(tipo, monto, saldo, intereses, numeroCuotas, diaPagoCuota, valorCuotaMinima, loginCliente);		
